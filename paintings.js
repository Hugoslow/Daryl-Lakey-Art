// ============================================================
//  DARYL LAKEY ART — PAINTINGS CONFIGURATION
// ============================================================
//  
//  HOW TO USE THIS FILE:
//  - Open in Notepad (right-click > Open with > Notepad)
//  - Each painting is a block between { and }
//  - Change any text between the quote marks to update the site
//  - To mark a painting as SOLD, change:  sold: false  to  sold: true
//  - To add a new painting, copy an entire block and paste it at the end
//    (make sure there's a comma after the } of the block before it)
//  - To remove a painting, delete the entire block from { to },
//  - Drop new painting images into the "images" folder
